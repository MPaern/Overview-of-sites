...
Here I'll see what the temperatures are like around my sites. I arranged the sites from north to south and I can see on @fig-temperature-overview that the mean temperatures are similar throughout the study area. To further highlight some outliers, we see that on @fig-temperature-mean that CM-07 has lower mean temperature during the detector work times and CM-01 and CM-02 have more stable temperatures as they are the only 2 locations on an island. CM-07 is located in a W-E facing valley.
